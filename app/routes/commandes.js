...
router.post('/', async (req, res) => {
 ...
 await commande.save();
 // 3. Invalider le cache (les données ont changé)
 ...
 commande,
 traitee_par: INSTANCE // montre quel serveur a répondu
 });
 } catch (err) {
...
// ── GET /commandes
//─────────────────────────────────────────
// Retourne toutes les commandes (avec cache Redis)
...
// At the end of routes/commandes.js
